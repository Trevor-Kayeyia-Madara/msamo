      ...
      <div className="content">
        ...
        {view === 'landlord' && (
          <div className="landlordSection">
            ...
            <div className="buttonContainer">
              <a href="/landlord-form" className="login-button">Landlord Form</a>
            </div>
          </div>
        )}
        ...
        {view === 'sellLand' && (
          <div className="sellLandSection">
            ...
            <div className="buttonContainer">
              <button to="/sellhome-form" className="login-button">Sell Home Form</button>
            </div>
          </div>
        )}
        ...
        {view === 'sellHome' && (
          <div className="sellHomeSection">
            ...
            <div className="buttonContainer">
              <button to="/sellland-form" className="login-button">Sell Land Form</button>
            </div>
          </div>
        )}
